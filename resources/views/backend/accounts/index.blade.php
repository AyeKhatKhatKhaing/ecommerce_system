...
@section('content')
    <h4 class="mb-3">အကောင့်</h4>
    <div class="card brand">
        <div class="card-header d-flex justify-content-between py-4">
            <a class="primary_button" href="{{route('account.create')}}">
                <div class="d-flex align-items-center">
                    <i class=" ri-add-circle-fill mr-2 primary-icon"></i>
                    <span class="button_content">အကောင့်အသစ်ဖန်တီးမည်</span>
                </div>
            </a>
        </div>
