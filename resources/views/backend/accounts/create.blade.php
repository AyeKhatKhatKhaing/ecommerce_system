        ...
        <div class="card">
            <div class="card-header">
                <a href="{{route('account')}}" class="card-title mb-0 d-inline-flex align-items-center create_title">
                    ...
                    <span class="create_sub_title">အကောင့်အသစ်ဖန်တီးမည်</span>
                </a>
            </div><!-- end card header -->
            <div class="card-body">
                <div class="row d-flex justify-content-center">
                    <div class="col-xl-9">
                        <form method="POST" action="{{route('account.store')}}" id="account_create" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="text-end submit-m-btn">
                                <button type="submit" class="submit-btn">အသစ်ပြုလုပ်မည့် အကောင့်</button>
                            </div>
                        </form>
                    </div>
                </div>
...
@section('script')
    {!! JsValidator::formRequest('App\Http\Requests\StoreAccountRequest', '#account_create') !!}
