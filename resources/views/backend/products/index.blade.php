        ...
        <div class="card-header d-flex justify-content-between py-4">
            <a class="primary_button" href="{{route('product.create')}}">
                <div class="d-flex align-items-center">
                    ...
                    <span class="button_content">ကုန်ပစ္စည်းအသစ်ပြုလုပ်မည်</span>
                </div>
            </a>
        </div>
        ...
        <div class="card-body">
            <table class="table table-bordered" id="datatable" style="width:100%;">
                <thead class="text-center">
                    ...
                    <th class="text-center">အမျိူးအစား / Category</th>
                    <th class="text-center">အမှတ်တံဆိပ်</th>
