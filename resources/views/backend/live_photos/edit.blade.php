        ...
        <div class="card">
            <div class="card-header">
                <a href="{{route('live')}}" class="card-title mb-0 d-inline-flex align-items-center create_title">
                    ...
                    <span class="create_sub_title">ပုံကိုပြုပြင်မည်</span>
                </a>
            </div><!-- end card header -->
            <div class="card-body">
                <div class="row d-flex justify-content-center">
                    <div class="col-xl-9">
                        <form method="POST" action="{{route('live.update', $photo->id)}}" id="account_update" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="upload mb-3">
                                <div class="preview_img">
                                    @if ($photo->image)
                                        <img src="{{$photo->image}}" alt="" width=150 height=150 alt="">
                                    @endif
                                </div>
                                <div class="round">
...
@section('script')
    {!! JsValidator::formRequest('App\Http\Requests\StoreLivePhotoRequest', '#account_update') !!}
    <script>
